...
export default function HomePage() {
  return (
    <BasicLayout>
      <div className="pt-2">
      <h1 data-testid= "welcome-header" style={{ padding: "20px"}}>Welcome to
      {" "}
      <div data-testid="UCSB" style={{backgroundColor:"#003660", padding: "0px 10px", fontWeight: "bold", display:"inline-block", color: "white" }}>
         UCSB
      </div> 
      {" "}
      GauchoRide!</h1>
